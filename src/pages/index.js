...
profileOverlayModal.addEventListener("click", closeOnOverlay);
postOverlayModal.addEventListener("click", closeOnOverlay);
previewOverlayModal.addEventListener("click", closeOnOverlay);
